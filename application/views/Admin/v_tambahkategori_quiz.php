...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form method="post" action="<?php echo base_url() . "admin/c_kategori_quiz/simpan"?>" class="form-horizontal form-label-left">
            <div class="form-group">
                <label for="kategori_quiz" class="control-label col-md-3 col-sm-3 col-xs-12">Kategori Quiz</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="kategori_quiz" class="form-control col-md-7 col-xs-12" type="text" name='kategori_quiz'>
                </div>
            </div>
            <div class="form-group">
