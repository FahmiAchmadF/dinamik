...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form id="demo-form2" method="post" action="<?php echo base_url();?>admin/c_berita/simpan" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
        ...
        <div class="panel-body">
            <div class="form-group">
                    <label for="judul<?php echo $b; ?>">Judul <span class="required"></span>
                         ...
                         <input type="text" id="last-name" name='judul<?php echo $b ;?>' maxlength='160' required="required" class="form-control col-md-7 col-xs-12">
