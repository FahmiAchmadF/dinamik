...
<!--       <div class="mainbar">
 ...
 -->        
 <!-- <form  method="post" action="<?php echo base_url()."user/c_forum/simpan_komen_topik"?>" class="form-horizontal form-label-left">
...
<br>
    <div class="columnsContainer2">
      ...
      <?php foreach ($lihat_topik as $row): ?>
      <div class="artikel-container">
        <p class="title-artikel"><?php echo $row->judul;?></p>
          <br>
        <img class="img-valign" src="<?php echo base_url();?>assets_users/img/forum-talk.png" alt="" />
      ...
      <?php foreach ($lihat_komentar as $data): ?>
       <div class="re-artikel-container">
        <p class="title-artikel">RE : <?php echo $row->judul;?></p>
          <br>
        <img class="img-valign" src="<?php echo base_url();?>assets_users/img/forum-talk.png" alt="" />
          <span class="non-data-text">Komentar Oleh </span><span class="data-text">Billy S P S</span><span class="non-data-text"> » </span></span><span class="non-data-text">Senin 18 Februari 2015</span><img class="img-valign" src="img/reply-comment.png" alt="" align="right"/>
          <span class="non-data-text-quote" style="float:right;margin-top:5px;margin-right:5px;">Balas Dengan Quote</span>
         <hr class="style3">
         <!-- ISI KOMENTAR -->
         <img class="img-valign" src="<?php echo base_url();?>assets_users/img/quote.png" alt="" />
          <span class="quote-text"><a><?php echo $row->nama_panggilan;?></a> Menulis : </span>
         <div class="comment-artikel-container">
<img src="<?php echo base_url();?>assets_users/img/header_bg.jpg" alt="" />
        <p align="center"><?php echo $row->isi;?></p> 
        </div>
        <p><?php echo $data->isi_komentar;?></p>
