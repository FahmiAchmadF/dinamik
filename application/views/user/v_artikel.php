    ...
    <div class="large-12">
      ...
      <div class="toggleview">
        ...
        <div class="large-12 forum-topic">
          <div class="large-1 column lpad">
            <i class="icon-file"><img src="'.$url.'images/'.$row->logo.'"></i>
          </div>
          <div class="large-7 small-8 column lpad">
            <span class="overflow-control">
              <a href="/kebudayaan_indonesia/user/c_artikel/tampil_artikel/'.$row->id.'">'.$row->kategori.'</a>
            </span>
            <span class="overflow-control">
            </span>
          </div>
...
<!-- <a href="<?php echo base_url();?>user/c_forum/tambah_topik" data-text="Buat Artikel" class="button-cate-hover">Buat Topik</a> -->
