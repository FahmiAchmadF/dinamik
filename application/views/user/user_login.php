...
<head>
    ...
    <title>Kebudayaan</title>
     ...
     <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/assets/bootstrap/css/bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/assets/css/styles.css" />
...
<body>
    ...
    <section class="container">
            <section class="login-form">
                <form method="post" action="<?php echo base_url();?>user/login/do_login" role="login">
